...
{
    private:
        void insertClone(Node* cloneHead, Node* cloneTail, int data){
    ...
    Node *copyList(Node *head)
    {
        ...
        while(ori != NULL){
            insertClone(cloneHead, cloneTail, ori->data);
            ori = ori->next;
        }
        ...
        while(tempClone != NULL && ori!=NULL){
          if(ori->arb != NULL){
                tempClone->arb = ori->arb->next;
          }
          else{
              tempClone->arb = NULL;
          }
